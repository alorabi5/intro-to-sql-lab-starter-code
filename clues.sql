...
-- Write SQL query here
SELECT name FROM countries JOIN countrylanguages ON countries.code = countrylanguages.countrycode WHERE language = 'Italian' AND region = 'Southern Europe' AND percentage = 100;
...
-- Write SQL query here
SELECT countries.name, cities.name FROM cities JOIN countries ON cities.countrycode = countries.code WHERE countries.region = 'South America' AND cities.name LIKE 'Serr%';
